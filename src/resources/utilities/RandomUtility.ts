import type { randomInt } from './random/randomInt';
import type { randomUint } from './random/randomUint';
import type { randomString } from './random/randomString';
import type { randomKey } from './random/randomKey';
import type { randomValue } from './random/randomValue';
...
/**
 * @deprecated Use
 *   {@linkcode randomInt}/{@linkcode randomUint}/{@linkcode randomString}/{@linkcode randomKey}/{@linkcode randomValue}
 *   instead
 */
